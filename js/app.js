...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
    <div class="single-product m-2 border border-dark rounded bg-white">
      <div class="p-3">
        <div>
          <img class="product-image" src=${image}></img>
        </div>
          <h3 class="a">${product.title.slice(0, 20)}</h3>
        ...
        <div class="ratings">
          <span>
            ...
            <div class="text-secondary" aria-label="3,022,510 ratings">Count: ${product.rating.count}   <i class="fas fa-user"></i></div>
